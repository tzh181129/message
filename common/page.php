...
class Page{
    ...
    $dispNum  每页显示的数据条数
    */
    public function __construct($queryStr='select * from message',$dispNum=4){
        $conn=new DBHelper();
        $result = mysqli_query($conn,$queryStr);
        $totalNum = mysqli_num_rows($conn,$result);
    ...
    private function showCurPage(){
        ...
        $result = mysqli_query($conn,$this->queryStr.$this->limitStr);
